...
namespace star
{
	...
	__host__ __device__ __forceinline__ unsigned uint_encode_rgb(const uchar3 rgb)
	{
	...
	__host__ __device__ __forceinline__ float float_encode_rgb(const uchar3 rgb)
	{
	...
	__host__ __device__ __forceinline__ void float_decode_rgb(const float encoded, uchar3 &rgb)
	{
		const auto unsigned_encoded = float_as_uint(encoded);
