...
template <int N>
void star::DenseLDLT<N>::Factor(float *matrix, float *factored)
{
	// The first itertion
...
template <int N>
void star::DenseLDLT<N>::Factor(float *matrix)
{
	DenseLDLT<N>::Factor(matrix, matrix);
}

template <int N>
void star::DenseLDLT<N>::Solve(const float *factored, float *b, float *auxiliary)
{
	// First solve L x_0 = b
	float *x_0 = auxiliary;
	x_0[0] = b[0];
...
template <int N>
void star::DenseLDLT<N>::Solve(const float *factored, float *b)
{
	float auxiliary[N];
