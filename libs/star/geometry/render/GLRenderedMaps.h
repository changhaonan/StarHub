...
namespace star
{
	...
	/**
	 * \brief: Used to get observation map from geometry (live).
	 * The observation map will be used for
	 */
	struct GLObservationMapsFrameRenderBufferObjects
	{
		GLuint observation_map_fbo;
		...
		// The buffer for cuda access
		cudaGraphicsResource_t cuda_rbo_resources[2];
		cudaArray_t cuda_mapped_arrays[2];
		cudaTextureObject_t cuda_mapped_texture[2];
