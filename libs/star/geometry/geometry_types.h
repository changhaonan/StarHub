...
// {
//     // Texture
//     template<unsigned num_cam>
//     struct GeometryMapTex {
//         using Ptr = std::shared_ptr<GeometryMapTex<num_cam>>;
//         cudaTextureObject_t vertex_confid_map[num_cam] = {0};
//         cudaTextureObject_t normal_radius_map[num_cam] = {0};
//         cudaTextureObject_t index_map[num_cam] = {0};
//         cudaTextureObject_t color_time_map[num_cam] = {0};
//         unsigned num_valid_surfel = 0;
//     };

//     using FusionMaps = GeometryMapTex<d_max_cam>;
//     // Solver map
//     struct SolverMaps
//     {
...
//     using Geometry4Fusion = GeometrySlice;
//     using Measure4Fusion = GeometryMapTex<d_max_cam>;
